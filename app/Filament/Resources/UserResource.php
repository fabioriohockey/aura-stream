    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('episodes_watched_today')
                    ->required()
                    ->numeric()
                    ->default(0),
                Forms\Components\DatePicker::make('last_watch_date'),
            ]);
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('subscription_expires_at')
                    ->dateTime()
                    ->sortable(),
                Tables\Columns\TextColumn::make('episodes_watched_today')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('last_watch_date')
                    ->date()
                    ->sortable(),
            ])
            ->filters([
